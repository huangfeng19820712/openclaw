...
DEPLOY_CMD="OPENCLAW_INSTANCE_ID=${INSTANCE_ID} "
DEPLOY_CMD+="OPENCLAW_CONFIG_DIR=${CONFIG_DIR} "
DEPLOY_CMD+="OPENCLAW_INSTANCE_BASE_DIR=${INSTANCE_BASE_DIR} "
DEPLOY_CMD+="OPENCLAW_PORT_OFFSET=${PORT_OFFSET} "
DEPLOY_CMD+="OPENCLAW_NO_ONBOARD=true "

if [ $SKIP_BUILD -eq 1 ]; then
  DEPLOY_CMD+="OPENCLAW_SKIP_BUILD=true "
fi

DEPLOY_CMD+="${WORKSPACE_DIR}/docker-instance-setup.sh"
